...
function blogger_buzz_breadcrumbs(){
	$breadcrumb_layout = get_theme_mod('blogger_buzz_breadcrumbs_layout','background_color');
    $breadcrumb_image = get_theme_mod('blogger_buzz_breadcrumbs_image');
    ?>
    <div class="breadcrumb" <?php if( $breadcrumb_layout == 'background_image' && ! empty($breadcrumb_image)){ ?> style="background-image: url(<?php echo esc_url($breadcrumb_image); ?>)" <?php } ?>>
