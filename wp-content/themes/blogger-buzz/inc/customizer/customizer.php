...
function blogger_buzz_customize_register( $wp_customize ) {
	...
	*/
	...
	$wp_customize->add_section('blogger_buzz_header_section', array(
		'title'		=>	esc_html__('Header Layout','blogger-buzz'),
	...
	$wp_customize->add_panel('blogger_buzz_homepage_blog_posts', array(
		...
		*/
		$wp_customize->add_section('blogger_buzz_banner_section', array(
			'title'		=>	esc_html__('Main Post Slider Settings','blogger-buzz'),
		...
		*/
		$wp_customize->add_section('blogger_buzz_blog_layout_section', array(
			'title'		=>	esc_html__('Posts Listing Settings','blogger-buzz'),
			'panel'	    => 'blogger_buzz_homepage_blog_posts',
			'priority'  => 3
		));
			...
			$wp_customize->add_control('blogger_buzz_blog_layout', array(
				'label'   => esc_html__('Blog Posts Layout','blogger-buzz'),
		...
		*/
		$wp_customize->add_section('blogger_buzz_instgram_posts_section', array(
			...
			$wp_customize->add_control('blogger_buzz_instagram_feed_shortcode', array(
			    ...
			    'description'     => esc_html__('Install Instagram Feed Plugin. Connect An Instagram Account. Set Number Of Photos And Number Columns To 10 And Padding Around Images to 0. And paste The Shortcode','blogger-buzz'),
			    'section'         => 'blogger_buzz_instgram_posts_section',
		...
		*/
		$wp_customize->add_panel('blogger_buzz_theme_options', array(
			...
			// Header Layout.
			$wp_customize->add_setting('blogger_buzz_breadcrumbs_layout', array(
				'default' => 'background_color',
				'sanitize_callback' => 'blogger_buzz_sanitize_select'         //done
			));

			$wp_customize->add_control('blogger_buzz_breadcrumbs_layout', array(
				'label'   => esc_html__('Breadcrumbs Background','blogger-buzz'),
				'section' => 'blogger_buzz_breadcrumbs_section',
				'type'    => 'select',
				'choices' => array(
					'background_color'   => esc_html__('Background Color','blogger-buzz'),
					'background_image'   => esc_html__('Background Image','blogger-buzz'),
			)));

			// Breadcrumb Image.
			$wp_customize->add_setting('blogger_buzz_breadcrumbs_image', array(
				'sanitize_callback'	=> 'esc_url_raw'		//done
			));

			$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'blogger_buzz_breadcrumbs_image', array(
				'label'	   		  => esc_html__('Upload Image','blogger-buzz'),
				'section'  		  => 'blogger_buzz_breadcrumbs_section',
				'type'	   		  => 'image',
				'active_callback' => 'blogger_buzz_breadcrumbs_image'
			)));

			/* Single Blog posts. */
			$wp_customize->add_section('blogger_buzz_single_posts_section', array(
				'title'		=>	esc_html__('Single Page Settings','blogger-buzz'),
				'panel'		=> 'blogger_buzz_theme_options',
				'priority'  => 70
			));
			...
			$wp_customize->add_control(new Blogger_Buzz_Switch_Control($wp_customize, 'blogger_buzz_enable_meta', array(
			    ...
			    'section'      => 'blogger_buzz_blog_meta_section',
			    'switch_label' => array(
			        'enable' => esc_html__('Enable', 'blogger-buzz'),
			        'disable' => esc_html__('Disable', 'blogger-buzz'),
			    ),
			...
			/* Sidebar. */
			$wp_customize->add_section('blogger_buzz_sidebar_section', array(
				'title'		=>	esc_html__('Sidebar Settings','blogger-buzz'),
				'panel'		=> 'blogger_buzz_theme_options',
				'priority'  => 110
			));
			...
			$wp_customize->add_control(new Blogger_Buzz_Switch_Control($wp_customize, 'blogger_buzz_sidebar', array(
			    ...
			    'section'      => 'blogger_buzz_sidebar_section',
			    'switch_label' => array(
			        'enable' => esc_html__('Enable', 'blogger-buzz'),
			        'disable' => esc_html__('Disable', 'blogger-buzz'),
			    ),
	...
	*/
	$wp_customize->add_panel('blogger_buzz_general_settings', array(
	   ...
	   'title' => esc_html__('General Settings', 'blogger-buzz')
	     ...
	     * Header Image
	    */
	    $wp_customize->get_section( 'header_image' )->panel = 'blogger_buzz_general_settings';
    	...
    	*/
		...
		$wp_customize->get_section( 'colors' )->title = esc_html__('Color Settings', 'blogger-buzz');
	...
	*/
	$wp_customize->add_section('blogger_buzz_footer', array(
		'title'		=>	esc_html__('Footer Settings','blogger-buzz'),
		'priority'  => 8
	));
