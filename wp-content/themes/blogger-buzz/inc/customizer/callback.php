...
/*
 *  Breadcrumbs Background Active Callback Function.
*/
function blogger_buzz_breadcrumbs_image(){
  $breadcrumbs_layout  = get_theme_mod('blogger_buzz_breadcrumbs_layout','background_color');


  if ( $breadcrumbs_layout == 'background_image') {
